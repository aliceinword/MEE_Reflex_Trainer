...
def render_global_styles():
    ...
    .section-heading {
        ...
        line-height: 1.28 !important;
        margin: 0.85rem 0 0.42rem 0 !important;
        padding: 0 !important;
        overflow: visible !important;
    }
    ...
    /* Plug & Play template boxes - mirrors the LBP worksheet style. */
    .plug-box {
        --plug-burgundy: #780C1B;
        --plug-burgundy-strong: #87101D;
        --plug-charcoal: #3B3434;
        --plug-blue: #B5D6FC;
        --plug-blue-strong: #006ED5;
        --plug-blue-soft: #EEF6FF;
        --plug-mint: #AEE3BD;
        --plug-mint-soft: #F1FFF5;
        --plug-pink: #F7BAC1;
        --plug-pink-soft: #FFF1F3;
        --plug-gold: #FBF1B4;
        --plug-paper: #FFFDFC;
        position: relative;
        background: var(--plug-paper);
        border: 2px solid rgba(135, 16, 29, 0.28);
        border-radius: 12px;
        padding: 1rem 1.05rem 1.05rem 1.25rem;
        margin: 0.55rem 0 0.9rem 0;
        box-shadow: 0 10px 26px rgba(59, 52, 52, 0.07);
        box-sizing: border-box;
        display: block;
        width: 100%;
        max-width: none;
        color: var(--plug-charcoal);
    ...
    .plug-section {
        min-width: 0;
        background: #FFFFFF;
        border: 1.5px solid rgba(0, 110, 213, 0.22);
        border-radius: 10px;
        padding: 0;
        overflow: hidden;
        box-shadow: 0 3px 10px rgba(59, 52, 52, 0.04);
    }

    .plug-title {
        color: var(--plug-burgundy) !important;
        font-family: "Century Gothic", "Segoe UI", Arial, sans-serif;
        font-weight: 900;
        ...
        padding: 0.15rem 0 0.42rem 0;
        border-bottom: 4px solid var(--plug-mint);
    }

    .plug-kicker {
        color: var(--plug-charcoal) !important;
        background: var(--plug-blue);
        border-left: 6px solid var(--plug-blue-strong);
        border-radius: 8px;
    ...
    .plug-meta-pill {
        display: inline-flex;
        color: var(--plug-charcoal);
        background: var(--plug-mint);
        border: 1.5px solid rgba(120, 12, 27, 0.18);
        border-radius: 999px;
    ...
    .plug-section-title {
        ...
        border-bottom: 1px solid rgba(59, 52, 52, 0.12);
    }

    .plug-section-title::before {
        content: "i";
        display: inline-flex;
        align-items: center;
        justify-content: center;
        ...
        height: 1rem;
        margin-right: 0.45rem;
        border: 1.5px solid var(--plug-blue-strong);
        border-radius: 999px;
        color: var(--plug-blue-strong);
        font-size: 0.72rem;
        font-weight: 900;
        line-height: 1;
    }
    ...
    .plug-placeholder {
        color: var(--plug-charcoal);
        background: var(--plug-gold);
        border-radius: 4px;
        padding: 0.05rem 0.24rem;
        font-weight: 850;
        box-shadow: inset 0 -1px 0 rgba(120, 12, 27, 0.18);
    }

    .plug-section-rule,
    .plug-section-analysis-template,
    .plug-section-conclusion,
    .plug-section-how-this-subject-is-tested {
        grid-column: 1 / -1;
    }

    .plug-section-rule {
        background: var(--plug-mint-soft);
        border-color: var(--plug-mint);
        border-left: 6px solid var(--plug-mint);
    }

    .plug-section-rule .plug-section-title {
        background: var(--plug-mint);
        color: var(--plug-charcoal) !important;
    }

    .plug-section-rule .plug-text {
        font-size: 17px;
        font-weight: 650;
        line-height: 1.66;
    }
    ...
    .plug-section-analysis-template {
        background: var(--plug-blue-soft);
        border-left: 6px solid var(--plug-blue);
    }

    .plug-section-analysis-template .plug-section-title {
        background: var(--plug-blue);
    }
    ...
    .plug-section-conclusion {
        background: #FFFDF4;
        border-color: #FBF1B4;
        border-left: 6px solid #B19400;
    }

    .plug-section-conclusion .plug-section-title {
        background: var(--plug-gold);
        color: var(--plug-charcoal) !important;
    }

    .plug-section-issue-statement,
    .plug-section-scenario-trigger {
        border-color: rgba(59, 52, 52, 0.12);
    }
    ...
    .plug-section-scenario-trigger .plug-section-title {
        background: var(--plug-blue);
    }

    .plug-section-issue-statement {
        background: var(--plug-pink-soft);
    }

    .plug-section-issue-statement .plug-section-title {
        background: var(--plug-pink);
    }

    .plug-section-how-this-subject-is-tested {
        background: var(--plug-pink-soft);
        border-color: var(--plug-pink);
        border-left: 6px solid var(--plug-pink);
    }

    .plug-section-how-this-subject-is-tested .plug-section-title {
        background: var(--plug-pink);
        color: var(--plug-charcoal) !important;
    }
